...
const cardContent = [
  ...
  },
  {
    ...
    text: "В обговоренное время приедет замерщик и снимет размеры вашего будущего изделия. Вы сможете задать ему все интересующие вопросы. Если вам сложно выбрать цвет по картике, замерщик привезёт с собой чемодан образцов, что бы вам было легче определиться.",
    image: icon2,
  },
  {
    number: 3,
